...
% check whether we loaded old summary data and remove
...
save(previous_results_filename,'edge_stats_summary','cluster_stats_summary','positives','positives_total','FWER_manual','-append');

...
%  figure;
% image(structure_data(nbs.NBS.edge_stats*50,'mask',triu(ones(268),'ismatrix',1)));

% visualize cluster and edge results side by side
% figure;
% image(triu(nbs_new.NBS.cluster_stats*50)+triu(structure_data(nbs_new.NBS.edge_stats*50,'mask',triu(ones(268),'ismatrix',1)))');

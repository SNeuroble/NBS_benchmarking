...
% Model
% file contains 2D matrix
design_matrix_file='/Volumes/GoogleDrive/My Drive/Lab/Misc/Software/scripts/Matlab/fmri/NBS1.2/SchizophreniaExample/designMatrix.mat';
contrast=[-1,1];
exchange=[];
...
edge_groups_file='/Volumes/GoogleDrive/My Drive/Lab/Misc/Software/scripts/Matlab/myscripts/NBS_benchmarking/NBS_addon/SchizophreniaExample/Example_74node_map.mat'; 
...
cluster_stat_type='Constrained';    % 'Parametric_Bonferroni' | 'Parametric_FDR' | 'Size' | 'TFCE' | 'Constrained' | 'Constrained_FDR' | 'Omnibus' | 'SEA' (under construction)

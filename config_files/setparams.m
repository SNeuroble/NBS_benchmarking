...
n_workers=99; % num parallel workers for parfor, if greater than num CPUs will replace w max
mapping_category='subnetwork'; % for cNBS
n_repetitions=500; % 1000;
n_subs_subset=40; % size of subset is full group size (N; N=n*2 for two sample t-test or N=n for one-sample)
...
% these parameters work for a small instance with 1 GB memory
if testing 
    n_repetitions=4; % TODO: change default back
    %n_repetitions=70;
	n_subs_subset=6;
	n_perms='20';
end

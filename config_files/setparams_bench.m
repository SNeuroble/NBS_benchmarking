...
task1='LANGUAGE'; % for TPR - EMOTION GAMBLING LANGUAGE MOTOR RELATIONAL SOCIAL WM
...
all_cluster_stat_types={'Size'}; % NBS stats to be benchmarked: {'Size', 'TFCE', 'Constrained', 'SEA', 'FDR', 'Omnibus', 'Parametric_FDR', 'Parametric_Bonferroni'} % note that FDR is a NONPARAMETRIC EDGE-LEVEL APPROACH
